...
public class DbHandler extends SQLiteOpenHelper {
    ...
    public ArrayList<HashMap<String, String>> GetUserByUserId(int userid){
        ...
        ArrayList<HashMap<String, String>> userList = new ArrayList<>();
        String query = "SELECT name, location, designation FROM "+ TABLE_Users;
        @SuppressLint("Recycle") Cursor cursor = db.query(TABLE_Users, new String[]{KEY_NAME, KEY_LOC, KEY_DESG}, KEY_ID+ "=?",new String[]{String.valueOf(userid)},null, null, null, null);
